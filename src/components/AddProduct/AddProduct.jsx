...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    await fetch("https://ecom-node-production.up.railway.app/upload", {
      method: "POST",
      headers: {
    ...
    if (responseData.success) {
      ...
      console.log(product);
      await fetch("https://ecom-node-production.up.railway.app/addproduct", {
        method: "POST",
        headers: {
          Accept: "application/json",
  ...
  return (
    <div className="add-product">
      ...
      <div className="box-select flex items-center gap-x-4">
